  ...
  const achievements = [
    {
      ...
      description:
        "Achieved highest marks in SSLC exams at Govt. Hr. Sec. School, Kunnagampoondi.",
    },
    {
      title: "School Topper in HSC",
      description:
        "Achieved highest marks in HSC exams at Govt. Hr. Sec. School, Kunnagampoondi.",
    },
    {
      title: "Spurs Scholar",
      description:
        "Awarded Spurs Scholarship for outstanding academic performance at School and Free Education for 4 Years of UG Program.",
    },
    {
      title: "NMMS Scholar",
      description:
        "Awarded Scholarship Worth of 48000.Selected across National level.",
    },
    {
      title: "TRUST Scholar",
      description:
        "Awarded Scholarship Worth of 4000.Selected and Got 9th Rank",
    },
    {
  ...
  return (
    ...
    >
      <div className="flex items-center mb-4 text-2xl">
        <FaMedal className="mr-4 text-blue-500 w-8 h-8" />
